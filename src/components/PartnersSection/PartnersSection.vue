<template lang="pug">
  section.PartnersSection.s-partners
    .s-container
      h2.s-title Partners and Affiliates
      .partners-wrap
        .partner-item
          .partner-item__title Safety
          .partner-item__logos
...
.partner-item
  ...
  &__logo
    ...
    padding: 5px 20px
    height: 58px
    background: rgba(32, 59, 176, 0.61)
    border-radius: 10px
    opacity: 1!important
    &:hover
      img
